...
public class HomeModel{
        ...
        public void refreshNewsList() {
            ...
            Log.d(TAG, "before pageCount:" + page + " totalCount:" + totalResult + " TotalReceivedCount:"
                    + receivedCount + " isLoadCompleted:" + isLoadCompleted);
            if (isLoadCompleted)
                return;
            ...
            restClient.getApiService().getAllArticles(++page).enqueue(new Callback<NewsModel>() {
                ...
                public void onResponse(Call<NewsModel> call, Response<NewsModel> response) {
                    if (response.isSuccessful()) {
                        ...
                        Log.d(TAG, "after pageCount:" + page + " totalCount:" + totalResult + " TotalReceivedCount:"
                                + receivedCount + " isLoadCompleted:" + isLoadCompleted);
